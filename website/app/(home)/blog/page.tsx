...
export const metadata = {
  ...createMetadata({
    title: 'Blog',
    description:
      'Practical CodeRadar notes on code review, evidence-gated findings, review pipelines, and local-first reliability.',
    path: '/blog',
  }),
  alternates: {
    canonical: '/blog',
    ...
    <main className="mx-auto w-full max-w-page px-4 pb-12 md:py-12">
      <div className="relative dark mb-4 aspect-[3.2] p-8 z-2 md:p-12">
        ...
        <p className="text-sm font-mono text-landing-foreground-200">
          Practical notes on code review, evidence-gated findings, and local-first reliability.
        </p>
      </div>
