...
import { thinkingOrbs } from '@/lib/thinking-orbs';
 ...
 * renderer (MIT, Jakub Antalik — notice kept in lib/thinking-orbs.ts): the canvas
 * carries the data-attribute contract and the module is initialized after mount,
 * then destroyed on unmount or when props change.
 */
